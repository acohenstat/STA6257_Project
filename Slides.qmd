...
### Histogram of Missing Data {.scrollable}
...
```
## Pooling and Fitting Imputed Dataset {.scrollable}
...
- We fit the complete model with the with() function and
...
for the original dataset. The p-value are similar and the differences are minimal with exception of bathrooms which is off just slightly.
