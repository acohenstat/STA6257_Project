...
-   The Likelihood Bayesian method

    -   predicts what the values of the missing data can by treating missing values as unobserved random variables that have a distribution based on previous observed data.

-   The weighting method

    -   involves weight subjects who are included in the analysis to compensate for those who were excluded because of missing values.

-   The imputation method

    -   when an estimate from the original dataset is used to estimate the missing value.

## What is Imputation? {.scrollable}
