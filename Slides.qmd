...
-   Missing data can occur in research for a variety of
reasons. 
-   It is never a good idea to ignore it. Doing this will lead to
biased estimates of parameters, loss of information, decreased
statistical power, and weak reliability of findings. 
-   The best course of action is to impute the missing data by using multiple
imputation.
