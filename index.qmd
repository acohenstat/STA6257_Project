...
dataset$capital.gain <- as.factor(dataset$capital.gain)
dataset$capital.loss <- as.factor(dataset$capital.loss)
...
network_string <- "[age|income][workclass|income][fnlwgt|income][education|income][education.num|income][marital.status|income][occupation|income][relationship|income][race|income][sex|income][capital.gain|income][capital.loss|income][hours.per.week|income][native.country|income][income]"
