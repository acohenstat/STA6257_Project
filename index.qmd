...
20,920 complete observations (not missing data). The total number of
missing data for each variable is as follows: price = 100, bedrooms =
200, bathrooms = 200, sqft_living = 200, which equal the 700 total
missing values. This visual gives a breakdown of where the missing data
occurs.
...
The estimates for the imputed dataset are very close to the estimates
