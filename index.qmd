...
<p style="color: blue;">
Idea - Talk about what limitations we ran into, complexity, assumptions, conditional independencies
</p>

<p style="color: blue;">
Idea - Talk about our method and how it can be applied in a real-world scenario, offering valuable insights and predictive capabilities. 
</p>

In conclusion, Bayesian Networks offer a robust framework for probabilistic modeling and decision-making under uncertainty. While they have certain limitations, their advantages make them a powerful tool for understanding and predicting complex relationships in diverse fields. Future work could explore integrating Bayesian Networks with other modeling techniques to address their limitations and further enhance their predictive performance.
