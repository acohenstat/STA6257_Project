...
Directed Acyclic Graph (DAG). [@pearl1986fusion] EEach node in the graph
...
fundamental concept used in this network. Bayes' theorem describes the
...
marginal probability (the total probability of $(B)$. The theorem's
formulation is crucial for understanding how evidence impacts our belief
in a hypothesis by combining prior knowledge with new evidence to
...
inference algorithms.[@pearl1986fusion]

***Idea - Look over the propagation into the networks and how it works
with different type of networks.***
...
Most workers are employed in the private sector, which tends to employ younger individuals with varying education levels, although at least a bachelor's degree is commonly observed. Notably, workers with a doctorate level of education often earn more than $50,000 per year.
...
Most occupations with incomes above $50,000 are in the "Exec-managerial" and "Prof-specialty" categories, followed by "Sales," "Craft-repair," and "Adm-clerical." However, within each of these occupational categories, the majority of workers earn $50,000 or less annually.


__Age Distribution by Income__
Individuals between the ages of 18 and 39, categorized as “young,” have a larger majority who are making $50,000 or less a year. Individuals between the ages of 40 and 64, categorized as “middle,” have a higher number of people making over $50,000. It is important to note that the “young” category has a much larger sample size. The amount of “middle-aged"  individuals making over $50,000 is not much larger than the amount of “young” individuals. Retired individuals have a much smaller sample size, with the majority making under $50,000.
...
__Number of Males and Females Making Above and Below $50,000__ 
...
__Number of Males and Females in Each Occupation__
...
__Number of People in Each Occupation Making Over and Under $50,000__
...
Idea - Talk about succeffully employing the Bayesian Network

</p>

<p style="color: blue;">

Idea - Highlight how the advantages of bayesian networks was used.

</p>

<p style="color: blue;">

Idea - Talk about what limitations we ran into, complexity, assumptions,
...
Idea - Talk about our method and how it can be applied in a real-world
scenario, offering valuable insights and predictive capabilities.

</p>

In conclusion, Bayesian Networks offer a robust framework for
probabilistic modeling and decision-making under uncertainty. While they
have certain limitations, their advantages make them a powerful tool for
understanding and predicting complex relationships in diverse fields.
Future work could explore integrating Bayesian Networks with other
modeling techniques to address their limitations and further enhance
