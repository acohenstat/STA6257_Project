...
probability (the probability of $(A)$ given $(B))$, $(P(B \mid A))$ is
the likelihood (the probability of $(B)$ given $(A)$, $P(A)$ is the
prior probability (the initial probability of $(A)$, and $(P(B))$ is the
